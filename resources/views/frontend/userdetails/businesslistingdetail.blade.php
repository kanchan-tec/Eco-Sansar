        ...
        <div class="row">
            <div class="col-md-7 col-sm-7">
                ...
                <section>
                    ...
                    <dl>
                        <dt>Sale/Giveaway</dt>
                        <dd>{{ $businessposts->sale_giveaway }}</dd>
                        <dt>Quantity</dt>
                        <dd>{{ $businessposts->min_weight }} {{ $businessposts->min_measure }} {{ 'to' }} {{ $businessposts->max_weight }} {{ $businessposts->max_measure }}</dd>
                        <dt>Clean/Unclean</dt>
                        <dd>{{ $businessposts->clean_unclean }}</dd>
                        <dt>Packaged</dt>
                        <dd>{{ $businessposts->packaged }}</dd>
                    </dl>
                </section>
                {{--  <section>
                    <h2>Features</h2>
