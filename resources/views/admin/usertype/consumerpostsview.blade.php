...
@slot('title') Consumer Posts @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-lg-12">
                        <h4 class="card-title">Consumer Posts Details</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <p class="mb-0"><strong>Post Image:</strong><br>
                            <img src="{{ asset('frontend/assets/img/Consumerpostimages/' . $users->post_pic) }}" alt="Post Image" class="img-thumbnail mb-2" style="max-width: 200px;">
                    </div>
                </div>
                </section>
                <div class="mt-3  text-center">
                        <a href="{{ route('user.consumerposts') }}" class="btn btn-primary waves-effect waves-light" >Back</a>
                    </div>
                    </div>
