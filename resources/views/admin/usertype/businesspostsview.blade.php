    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row ">
                    <div class="col-lg-12">
                        <h4 class="card-title">Business Posts Details</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <p class="mb-0"><strong>Free flow text:</strong><br>
                        <p>@isset($users->description){{ $users->description }}@endisset</p>
                    </div>
                    <div class="col-4">
                        <p class="mb-0"><strong>Post Image:</strong><br>
                            <img src="{{ asset('frontend/assets/img/Businesspostimages/' . $users->post_pic) }}" alt="Post Image" class="img-thumbnail mb-2" style="max-width: 200px;">
                    </div>
                </div>
                </section>
                <div class="mt-3  text-center">
                        <a href="{{ route('user.businessposts') }}" class="btn btn-primary waves-effect waves-light" >Back</a>
                    </div>
                    </div>
